    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clientes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_cliente') ? 'is-invalid' : '' }}" type="text" name="nombre_cliente" id="nombre_cliente" value="{{ old('nombre_cliente', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correo_cliente') ? 'is-invalid' : '' }}" type="email" name="correo_cliente" id="correo_cliente" value="{{ old('correo_cliente') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono_cliente') ? 'is-invalid' : '' }}" type="number" name="telefono_cliente" id="telefono_cliente" value="{{ old('telefono_cliente', '') }}" step="1" required>
