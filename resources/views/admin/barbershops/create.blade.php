...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.barbershop.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.barbershops.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_barbershop') ? 'is-invalid' : '' }}" type="text" name="nombre_barbershop" id="nombre_barbershop" value="{{ old('nombre_barbershop', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direccion_barbershop') ? 'is-invalid' : '' }}" type="text" name="direccion_barbershop" id="direccion_barbershop" value="{{ old('direccion_barbershop', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono_barbershop') ? 'is-invalid' : '' }}" type="number" name="telefono_barbershop" id="telefono_barbershop" value="{{ old('telefono_barbershop', '') }}" step="1" required>
