...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.servicio.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.servicios.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_servicio') ? 'is-invalid' : '' }}" type="text" name="nombre_servicio" id="nombre_servicio" value="{{ old('nombre_servicio', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precio_servicio') ? 'is-invalid' : '' }}" type="number" name="precio_servicio" id="precio_servicio" value="{{ old('precio_servicio', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('duracion_servicio') ? 'is-invalid' : '' }}" type="text" name="duracion_servicio" id="duracion_servicio" value="{{ old('duracion_servicio') }}" required>
